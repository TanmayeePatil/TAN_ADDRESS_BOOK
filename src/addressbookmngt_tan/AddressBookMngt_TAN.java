 ...
 * @author tanmayee
 */
public class AddressBookMngt_TAN {

	
	Scanner scanner = new Scanner(System.in);

	public static void main(String[] args) {
		AddressBookMngt_TAN addressBook = new AddressBookMngt_TAN();
		AddressBookMngt_TAN.askUser();
	}
	...
	void writeBook(JSONObject jsonObject) {
		...
		File file = new File("C:/Users/tanmayee/Documents/NetBeansProjects/AddressBookMngt_TAN/BookOfAddress.txt");
		if (!file.exists()) {
			try {
				file.createNewFile();
			} catch (IOException e) {
			...
			try {
				bookArray = (JSONArray) parser.parse(new FileReader("C:/Users/tanmayee/Documents/NetBeansProjects/AddressBookMngt_TAN/BookOfAddress.txt"));
			} catch (IOException e) {
			}
		}
	...
	void printWriter(JSONArray bookArray) {
		try {
			PrintWriter printWriter = new PrintWriter("C:/Users/tanmayee/Documents/NetBeansProjects/AddressBookMngt_TAN/BookOfAddress.txt");
